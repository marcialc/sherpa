/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/worker/wrangler.jsonc --strict-vars=false apps/worker/worker-configuration.d.ts` (hash: 70a0d55447445a710ab450b5bec93c6b)
// Runtime types generated with workerd@1.20260911.1 2026-09-13 nodejs_compat
interface __BaseEnv_Env {
	INDEX_DB: D1Database;
	INDEX_ENABLED: string;
	INDEX_MODEL: string;
	INDEX_CONFIG_JSON: string;
	...
	MAX_REVIEW_COST_USD: string;
	MAX_AGENT_CALLS: string;
	MAX_REVIEW_DURATION_MS: string;
	ALLOW_REPOSITORY_VALIDATION: string;
	GITHUB_APP_ID: string;
	GITHUB_PRIVATE_KEY: string;
	GITHUB_WEBHOOK_SECRET: string;
	GITHUB_CLIENT_SECRET: string;
	SETUP_SESSION_SECRET: string;
	REVIEW_LEDGER: DurableObjectNamespace<import("./src/index").ReviewLedger>;
	REVIEW_SANDBOX: DurableObjectNamespace<import("./src/index").ReviewSandbox>;
	INSTALLATION_SETTINGS: DurableObjectNamespace<import("./src/index").InstallationSettings>;
	REVIEW_WORKFLOW: Workflow<Parameters<import("./src/index").ReviewWorkflow['run']>[0]['payload']>;
	INDEX_WORKFLOW: Workflow<Parameters<import("./src/index").RepositoryIndexWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ReviewLedger" | "ReviewSandbox" | "InstallationSettings";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "INDEX_ENABLED" | "INDEX_MODEL" | "INDEX_CONFIG_JSON" | "GITHUB_CLIENT_ID" | "PUBLIC_BASE_URL" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_AI_GATEWAY_ID" | "ROUTER_PROVIDER" | "ROUTER_MODEL" | "SPECIALIST_PROVIDER" | "SPECIALIST_MODEL" | "JUDGE_PROVIDER" | "JUDGE_MODEL" | "MODEL_PRICING_JSON" | "ALLOWED_MODELS_JSON" | "MAX_REVIEW_COST_USD" | "MAX_AGENT_CALLS" | "MAX_REVIEW_DURATION_MS" | "ALLOW_REPOSITORY_VALIDATION" | "GITHUB_APP_ID" | "GITHUB_PRIVATE_KEY" | "GITHUB_WEBHOOK_SECRET" | "GITHUB_CLIENT_SECRET" | "SETUP_SESSION_SECRET">> {}
}
