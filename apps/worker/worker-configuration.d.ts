/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/worker/wrangler.jsonc --strict-vars=false apps/worker/worker-configuration.d.ts` (hash: 277b495fdacb3443bd33e4c3bc022d9d)
